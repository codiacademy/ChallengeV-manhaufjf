...
function Footer() {
    ...
    return (
        <div className="w-full md:h-[500px] h-auto bg-magic-500 flex flex-col items-center justify-center">
            <div className="flex md:gap-52 md:items-center mt-10 gap-9 md:flex-row flex-col">
                <div> 
                    ...
                    <ul className="text-base font-[Poppins] text-offwhite">
                        {
                            Links.map((link, i) => (
                                <li className="hover:text-white hover:underline hover:underline-offset-2 cursor-pointer duration-300" key={i}>{link}</li>
                            ))
                        }
                    </ul>
                </div>
